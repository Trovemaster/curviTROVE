...
use accuracy, only: dp=>rk, out
implicit none
private
public spline3pars, spline3valder, iix, iixmin, iixun, iixexp, poly3, dpoly3, d2poly3, spline3, spline3ders
...
subroutine stop_error(s)
  character(*), intent(in) :: s
  write(out, '(/a,1x,a)') 'splines error:', trim(s)
  stop
