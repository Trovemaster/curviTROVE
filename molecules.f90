  ...
  subroutine MLdefine_potenfunc
   ...
   if (verbose>=6) write(out,"(/'MLdefine_potenfunc/start')")
    ...
    case('POTEN_XY3_MLT')
         ...
         !
    case('POTEN_XY3_MORBID_10','POTEN_XY3_MORBID_10_MEP','POTEN_XY3_MORBID_10_DBOC','POTEN_XY3_MORBID_10_DBOC_HALF')
         !
    ...
    case('POTEN_ABCD_REF')
     ...
     case('POTEN_H2O2_KOPUT')
         ...
         !
     case('POTEN_H2O2_KOPUT_MORSE','POTEN_C2H2_STREY_MILLS')
         !
     ...
     case('POTEN_C2H2_KATY')
         ...
         !
    case('POTEN_CH3_SCHWENKE')
         !
         MLpotentialfunc => MLpoten_ch3_schwenke
         !
     case('POTEN_C2H2_MLT')
         !
    ...
    case('POTEN_USER','USER','GENERAL','POTEN')
         ...
         !
    case('POTEN_XY4_NIKITIN','POTEN_XY4_ALPHA')
         !
  ...
  recursive subroutine MLextF_func_define
   ...
   if (verbose>=6) write(out,"(/'MLextF_func_define/start')")
    ...
    case('XY3_MB4')
        ...
        !
    case('XY3_SYMMB','DIPOLE_XY3_SYMMB')
       !
    ...
    case('ZXY3_SYM')
       ...
       !
    case('DIPOLE','USER','GENERAL','DIPOLE_USER','DIPOLE_XY4_ALPHA')
       !
