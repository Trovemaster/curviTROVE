...
module pot_zxy2
  ...
  public MLpoten_h2cs_damp,MLpoten_zxy2_mlt,MLpoten_H2CO_Martin
  private
...
function MLpoten_H2CO_Martin(ncoords,natoms,local,xyz,force) result(f)
  ...
  integer(ik) :: i
  real(ark) :: r0_eq,r1_eq,r2_eq,alpha1_eq,alpha2_eq,rho_eq
  real(ark) :: r0,r1,r2,alpha1,alpha2,rho,r0_spf,r1_spf,r2_spf,s1,s2,s3,s4,s5,s6,v

  real(ark) :: F11,F12,F13,F22,F23,F33,F44,F55,F56,F66,F111,F112,F113,F122,F123,F133,F144,F155,F156,F166,F222,F223,F233,F244,F255,F256,&
               F266,F333,F344,F355,F356,F366,F1111,F1112,F1113,F1122,F1123,F1133,F1144,F1155,F1156,F1166,F1222,F1223,F1233,F1244,F1255,&
               F1256,F1266,F1333,F1344,F1355,F1356,F1366,F2222,F2223,F2233,F2244,F2255,F2256,F2266,F2333,F2344,F2355,F2356,F2366,F3333,&
               F3344,F3355,F3356,F3366,F4444,F4455,F4456,F4466,F5555,F5556,F5566,F5666,F6666
  ...
  r1 = local(2)     ! r_{CH_1}
  r2 = local(3)     ! r_{CH_2}
  alpha1 = local(4) ! alpha_{H_1CO}
  alpha2 = local(5) ! alpha_{H_2CO}
  rho = local(6)    ! out-of-(CH2)plane angle rho_{H_1COH_2}
  ...
  r1_eq = force(2)
  r2_eq = r1_eq
  alpha1_eq = force(3)*real(pi,ark)/180.0_ark
  alpha2_eq = alpha1_eq
  rho_eq = force(4)*real(pi,ark)/180.0_ark

  ! Simons-Parr-Finlan coords

  r0_spf = (r0 - r0_eq)/r0
  r1_spf = (r1 - r1_eq)/r1
  r2_spf = (r2 - r2_eq)/r2

  ! symmetry-adapted coords

  s1 = (r1_spf + r2_spf)/sqrt(2.0_ark)
  s2 = r0_spf
  s3 = (alpha1 + alpha2 - alpha1_eq - alpha2_eq)/sqrt(2.0_ark)
  s4 = rho - rho_eq
  s5 = (r1_spf - r2_spf)/sqrt(2.0_ark)
  s6 = (alpha1 - alpha2)/sqrt(2.0_ark)
  ...
  v = F11  *s1*s1 + &
    ...
    f = v*real(1.0e-11/planck/vellgt,ark) !  50340.359783704819122_rk

  end function MLpoten_H2CO_Martin
